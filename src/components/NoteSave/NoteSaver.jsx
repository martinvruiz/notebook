...
const handleSubmit = (e)=>{
    ...
    return <div className="flex w-full flex-col items-center">
        ...
        <form action="note" onSubmit={handleSubmit} className=" my-2 p-2 flex flex-col gap-3 w-full items-center">
            ...
            <input type="text" placeholder="Ingrese su nota!" onChange={handleNote} maxLength="50" className="border border-blue-600 focus:border-4 focus:outline-none text-center w-2/4 rounded-xl min-h-24"/>
